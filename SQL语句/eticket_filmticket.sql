...
-- ----------------------------
-- Table structure for eticket_filmticket
-- ----------------------------
DROP TABLE IF EXISTS `eticket_filmticket`;
CREATE TABLE `eticket_filmticket`  (
  ...
  `cinema_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `film_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
