...
-- ----------------------------
-- Table structure for eticket_entertainmentticket
-- ----------------------------
DROP TABLE IF EXISTS `eticket_entertainmentticket`;
CREATE TABLE `eticket_entertainmentticket`  (
