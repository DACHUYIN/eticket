...
-- ----------------------------
-- Table structure for eticket_showticket
-- ----------------------------
DROP TABLE IF EXISTS `eticket_showticket`;
CREATE TABLE `eticket_showticket`  (
  ...
  `show_hall_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `show_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
