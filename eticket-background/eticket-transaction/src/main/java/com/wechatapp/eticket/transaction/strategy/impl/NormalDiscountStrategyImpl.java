...
@Service
public class NormalDiscountStrategyImpl implements IServiceChargeDiscountStrategy {

	@Override
	public BigDecimal CalcDiscountCharge(BigDecimal originalServiceCharge) {
		BigDecimal currentCharge = originalServiceCharge.multiply(MemberShipDiscountConstant.NORMAL_DISCOUNT);
